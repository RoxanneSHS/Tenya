...
~ THEN REPLY #%jrnj0%9946 GOTO B2#TEN4a
  IF ~  ReactionLT(LastTalkedToBy,NEUTRAL_LOWER)
~ THEN REPLY #%jrnj0%9947 GOTO B2#TEN4b
  IF ~  Dead("Jebadoh")
~ THEN REPLY #%jrnj0%9948 GOTO B2#TEN4c
  IF ~  !Dead("Jebadoh")
~ THEN REPLY #%jrnj0%9952 GOTO B2#TEN4b
  IF ~~ THEN REPLY #%jrnj0%9953 GOTO B2#TEN4d
END
...
IF ~NumberOfTimesTalkedTo(0)~ THEN BEGIN 0
  SAY @42
  IF ~~ THEN REPLY #%jrnj0%1821 SOLVED_JOURNAL #%jrnj%27439 GOTO 1
  IF ~  !Global("HelpJebadoh","GLOBAL",0)
ReactionLT(LastTalkedToBy,NEUTRAL_LOWER)
~ THEN REPLY #%jrnj0%1822 GOTO 2
  IF ~  !Global("HelpJebadoh","GLOBAL",0)
~ THEN REPLY #%jrnj0%1823 GOTO 2
  IF ~  !Global("HelpJebadoh","GLOBAL",0)
ReactionGT(LastTalkedToBy,HOSTILE_UPPER)
~ THEN REPLY #%jrnj0%1824 GOTO 14
  IF ~  PartyHasItem("MISC53")
~ THEN REPLY #%jrnj0%1836 GOTO 11
END
END
...
~ THEN BEGIN 23
  SAY #%jrnj0%9940
  IF ~  ReactionLT(LastTalkedToBy,NEUTRAL_LOWER)
~ THEN REPLY #%jrnj0%9961 GOTO B2#TEN4e
  IF ~  ReactionGT(LastTalkedToBy,HOSTILE_UPPER)
~ THEN REPLY #%jrnj0%9962 GOTO B2#TEN4f
  IF ~  ReactionGT(LastTalkedToBy,NEUTRAL_UPPER)
~ THEN REPLY #%jrnj0%9964 GOTO B2#TEN4g
  IF ~  ReactionLT(LastTalkedToBy,FRIENDLY_LOWER)
~ THEN REPLY #%jrnj0%9965 GOTO B2#TEN4h
END
END
